...
flags.DEFINE_integer("seg_dim", 80, "Embedding size for segmentation, 0 if not used")
...
flags.DEFINE_string("script", "conlleval", "evaluation s cript")
flags.DEFINE_string("result_path", "result", "Path for results")
flags.DEFINE_string("emb_file", os.path.join("data9", "vec.txt"),  "Path for pre_trained embedding")
flags.DEFINE_string("train_file", os.path.join("data9", "example.train"), "Path for train data")
flags.DEFINE_string("dev_file", os.path.join("data9", "example.dev"), "Path for dev data")
flags.DEFINE_string("test_file", os.path.join("data9", "example.test"), "Path for test data")
